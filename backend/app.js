...
app.use(cors());
var mongoDB =
  "mongodb+srv://MeetUCan:testpassword@cluster0.rtqhj.mongodb.net/myFirstDatabase?retryWrites=true&w=majority";
...
app.post("/testPost", (req, res) => {
  ...
  var meeting1 = new schemas.Meeting({
    name: "meeting1",
    date: Date.now,
    timestart: Date.now,
    timeend: Date.now,
    timestoAvoid: [Date.now],
    people: [person1],
  });
